...
Web accessibility it's an inclusive practice for potential users with disabilities. That means that websites, and other technologies are designed and developed implementing functional accessible practices tools.

2. Talk about 3 different things you can do to ensure your website is accessible.

There is much more than 3 things to make an website accessible. First it's important to make sure that your website is keyboard-friendly, and the user will not have problems with the navigation.
It's also important to be mindful with colors, making sure that text stands out against background colors.
Also, the use of Aria attributes it's essential for people with disability.
